...
local fileManager = "kitty bash -c 'yazi; exec bash'"
local menu = "~/.config/wofi/start_wofi.sh"
...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("python3 ~/workspace/calendar/main.py")
end)
...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "rgba(75dcffee)", "rgba(b4befeee)" }, angle = 45 },
